...
function App() {
  ...
  const skills = {
    "Programming Languages": {
      skills: ["Python", "TypeScript", "JavaScript", "HTML5", "CSS3"],
      icon: Code
    },
    "Data Science & Machine Learning": {
      skills: ["Machine Learning", "Data Analysis", "Pandas", "NumPy", "Scikit-learn", "Statistics", "Data Visualization"],
      icon: Database
    },
    "Frontend Development": {
      skills: ["React", "Next.js", "Tailwind CSS", "Bootstrap", "Responsive Design", "UI/UX Design"],
      icon: Code
    },
    "Tools & Technologies": {
      skills: ["Git", "Linux", "MySQL", "MongoDB", "Tableau", "Power BI", "DaVinci Resolve", "Adobe Lightroom"],
      icon: Wrench
    }
  };
          ...
          <div className="space-y-8">
            ...
            >
              <p className="text-lg sm:text-xl leading-relaxed font-medium text-white">
                As a recent Computer Science graduate, I specialize in bridging the gap between data science and front-end development to bring complex data to life.
              </p>
            </div>
            ...
            >
              <p className="text-base sm:text-lg leading-relaxed text-gray-300">
                My expertise lies in developing interactive and intuitive user experiences from complex datasets. I architect clean, responsive interfaces using modern technologies like TypeScript, React, and Next.js, and power them with robust data insights derived from the end-to-end data science pipeline, including Python, Scikit-learn, and SQL. My goal is to transform raw data into actionable intelligence through user-centric applications like dynamic dashboards and smart recommendation engines.

I am a highly analytical and collaborative problem-solver committed to continuous learning. I am currently seeking a full-time role as a Junior Data Scientist or Machine Learning Engineer within an innovative, mentorship-driven team where I can contribute to solving real-world challenges and help build a data-driven future.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="space-y-4 max-w-md mx-auto">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center transition-colors text-gray-300 hover:text-white text-sm sm:text-base"
                >
